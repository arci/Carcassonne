...
public class BuildingInfoClosedTest {
	...
	public void simpleClosedTest() {
		...
		assertTrue(new BuildingInfo(grid.getCellByCoordinates(new Coordinate(0,
				0)), CardinalPoint.WEST, true).isClosed());
	}
	...
	public void checkCrossToCrossStreetClosed() {
		...
		// parti a controllare dall'inizio
		assertTrue(new BuildingInfo(grid.getCellByCoordinates(new Coordinate(2,
				2)), CardinalPoint.SOUTH, true).isClosed());
		// parti a controllare dalla fine
		assertTrue(new BuildingInfo(grid.getCellByCoordinates(new Coordinate(0,
				0)), CardinalPoint.EAST, true).isClosed());
		// parti a controllare da un punto in mezzo
		assertTrue(new BuildingInfo(grid.getCellByCoordinates(new Coordinate(2,
				0)), CardinalPoint.NORTH, true).isClosed());
	...
	public void checkCircleStreetClosed() {
		...
		assertTrue(new BuildingInfo(grid.getCellByCoordinates(new Coordinate(0,
				1)), CardinalPoint.SOUTH, true).isClosed());
		assertTrue(new BuildingInfo(grid.getCellByCoordinates(new Coordinate(1,
				1)), CardinalPoint.WEST, true).isClosed());
	...
	public void checkDonutCityClosed() {
		...
		assertTrue(new BuildingInfo(grid.getCellByCoordinates(new Coordinate(0,
				0)), CardinalPoint.EAST, true).isClosed());
		assertTrue(new BuildingInfo(grid.getCellByCoordinates(new Coordinate(1,
				1)), CardinalPoint.NORTH, true).isClosed());
		assertTrue(new BuildingInfo(grid.getCellByCoordinates(new Coordinate(
				-1, 1)), CardinalPoint.SOUTH, true).isClosed());
	...
	public void checkExtremeCityClosed() {
		...
		assertTrue(new BuildingInfo(grid.getCellByCoordinates(new Coordinate(1,
				1)), CardinalPoint.NORTH, true).isClosed());
		assertTrue(new BuildingInfo(grid.getCellByCoordinates(new Coordinate(
				-1, 1)), CardinalPoint.EAST, true).isClosed());
	...
	public void multiClosuresTest() {
		...
		// controlla city a SOUTH
		assertTrue(new BuildingInfo(grid.getCellByCoordinates(new Coordinate(2,
				0)), CardinalPoint.SOUTH, true).isClosed());
		// controlla street a EAST
		assertTrue(new BuildingInfo(grid.getCellByCoordinates(new Coordinate(2,
				0)), CardinalPoint.EAST, true).isClosed());
		// controlla street a WEST
		assertTrue(new BuildingInfo(grid.getCellByCoordinates(new Coordinate(2,
				0)), CardinalPoint.WEST, true).isClosed());
